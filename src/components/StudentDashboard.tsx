...
export const StudentDashboard: React.FC<StudentDashboardProps> = ({
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6 md:space-y-8 animate-fade-in relative transition-all min-h-screen">
            {showProfileModal && (
                <UserProfileModal
                    user={student}
            ...
            {viewMode === 'DASHBOARD' && (
                <>
                    ...
                    {/* --- SCHOOL INFO BANNER --- */}
                    <div className="flex flex-col md:flex-row items-center justify-between bg-white/5 rounded-xl p-4 border border-white/10 mb-6 gap-4 relative">
                        ...
                        <div className="grid grid-cols-2 gap-3 w-full lg:w-auto">
                            ...
                            <div className="flex items-center gap-2 md:gap-3 px-3 md:px-5 py-2 md:py-3 rounded-2xl bg-yellow-900/20 border border-yellow-500/30 backdrop-blur-md">
                                ...
                                <div className="min-w-0">
                                    <div className="text-[10px] md:text-xs text-yellow-500 font-bold uppercase tracking-wider truncate">XP Points</div>
                                    <div className="text-sm md:text-xl font-display font-bold text-white truncate">{xp.toLocaleString()}</div>
                                </div>
                            </div>

                            {/* Rank Badge */}
                            <div className="flex items-center gap-2 md:gap-3 px-3 md:px-5 py-2 md:py-3 rounded-2xl bg-purple-900/20 border border-neon-purple/30 backdrop-blur-md">
                                <div className="p-1.5 md:p-2 bg-neon-purple/20 rounded-lg text-neon-purple">
                    ...
                    {/* --- NAVIGATION --- */}
                    <div className="flex items-center w-full overflow-x-auto scrollbar-hide border-b border-white/5 pb-2 -mx-4 px-4 md:mx-0 md:px-0">
                        <div className="flex gap-4 min-w-max">
                            {TABS.map(t => (
                                <button
                                    ...
                                    className={`
                                        flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 font-medium whitespace-nowrap
                                        ${activeTab === t.id
                            ...
                            <button
                                onClick={onJoinClassClick}
                                className="flex items-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 font-medium text-neon-cyan hover:bg-neon-cyan/10 hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] whitespace-nowrap"
                            >
                    ...
                    {activeTab === 'LEARN_AI' && (
                        <div className="flex items-center w-full overflow-x-auto scrollbar-hide mb-6 -mx-4 px-4 md:mx-0 md:px-0">
                            <div className="flex gap-2 min-w-max animate-in fade-in slide-in-from-top-2 duration-300 pb-2">
                                {AI_TABS.filter(t => {
                                    ...
                                    <button
                                        ...
                                        className={`
                                            flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-bold transition-all whitespace-nowrap
                                            ${activeAiTab === t.id
